function Get-ComputerOpticalDrive {
    <#
    .SYNOPSIS
    Returns OpticalDrive data for a specific computer

    .DESCRIPTION
    Returns OpticalDrive data for a specific computer

    .NOTES
    The attributes given here are influenced by the columns in the "OpticalDrive" tab of the "SQL Server Inventory - Windows" workbook.
    ...
    .EXAMPLE
    Get-ComputerOpticalDrive -Computer localhost
    ...
    process {
        try {
            ...
            foreach ($c in $Computer) {
                ...
                $CIMOpticalDrive = Get-CimInstance -CimSession $CIMSession -Namespace $NameSpace -ClassName 'Win32_CDROMDrive'

                foreach ($Item in $CIMOpticalDrive) {
                    ...
                    $Props = [PSCustomObject] @{
                        ...
                        'OpticalDrive Name'        = $Item.'Name'
                        'Media Type'               = $Item.'MediaType'
                        'OpticalDrive Description' = $Item.'Description'
                    }
                    $Props
                }
            }
