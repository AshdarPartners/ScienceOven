    ...
    process {
        try {
            ...
            foreach ($c in $Computer) {
                ...
                $CIMEventLog = Get-CimInstance -CimSession $CIMSession -Namespace $NameSpace -ClassName 'Win32_NTEventlogFile'

                foreach ($Item in $CIMEventLog) {
                    ...
                    $Props = [PSCustomObject] @{
                        ...
                        'Overwrite Policy' = $Item.'OverwritePolicy'
                    }
                    $Props
                }
            }
