function Get-ComputerPrinter {
    <#
    .SYNOPSIS
    Returns Printer data for a specific computer

    .DESCRIPTION
    Returns Printer data for a specific computer

    .NOTES
    The attributes given here are influenced by the columns in the "Printer" tab of the "SQL Server Inventory - Windows" workbook.
    ...
    .EXAMPLE
    Get-ComputerPrinter -Computer localhost
    ...
    process {
        try {
            ...
            foreach ($c in $Computer) {
                ...
                $CIMPrinterConfiguration = Get-CimInstance -CimSession $CIMSession -Namespace $NameSpace -ClassName 'Win32_PrinterConfiguration'

                foreach ($Item in $CIMPrinterConfiguration) {
                    ...
                    $Props = [PSCustomObject] @{
                        ...
                        'Printer Description' = $Item.'Description'
                    }
                    $Props
                }
            }
