function Get-ComputerStartupCommand {
    <#
    .SYNOPSIS
    ...
    process {
        try {
            ...
            foreach ($c in $Computer) {
                ...
                $CIMStartupCommand = Get-CimInstance -CimSession $CIMSession -Namespace $NameSpace -ClassName 'Win32_StartupCommand'

                foreach ($Item in $CIMStartupCommand) {
