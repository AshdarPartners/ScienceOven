function Get-ComputerTapeDrive {
    <#
    .SYNOPSIS
    Returns TapeDrive data for a specific computer

    .DESCRIPTION
    Returns TapeDrive data for a specific computer

    .NOTES
    The attributes given here are influenced by the columns in the "TapeDrive" tab of the "SQL Server Inventory - Windows" workbook.
    ...
    .EXAMPLE
    Get-ComputerTapeDrive -Computer localhost
    ...
    process {
        try {
            ...
            foreach ($c in $Computer) {
                ...
                $CIMTapeDrive = Get-CimInstance -CimSession $CIMSession -Namespace $NameSpace -ClassName 'Win32_CDROMDrive'

                foreach ($Item in $CIMTapeDrive) {
                    ...
                    $Props = [PSCustomObject] @{
                        ...
                        'TapeDrive Name'        = $Item.'Name'
                        'Media Type'            = $Item.'MediaType'
                        'TapeDrive Description' = $Item.'Description'
                    }
                    $Props
                }
            }
