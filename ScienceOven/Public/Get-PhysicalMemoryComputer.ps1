    ...
    process {
        try {
            ...
            foreach ($c in $Computer) {
                ...
                $CIMPhysicalMemory = Get-CimInstance -CimSession $CIMSession -Namespace $NameSpace -ClassName 'Win32_PhysicalMemory'
                ...
                foreach ($Item in $CIMPhysicalMemory) {
                    ...
                    $Props = [PSCustomObject] @{
                        ...
                        'Bank Label'      = $Item.BankLabel
                        'Capacity'        = $Item.Capacity
                        'Device Locator'  = $Item.DeviceLocator
                        'Form Factor'     = $Item.FormFactor
                        'Hot Swappable'   = $Item.HotSwappable
