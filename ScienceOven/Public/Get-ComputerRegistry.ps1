function Get-ComputerRegistry {
    <#
    .SYNOPSIS
    Returns Registry data for a specific computer

    .DESCRIPTION
    Returns Registry data for a specific computer

    .NOTES
    The attributes given here are influenced by the columns in the "Registry" tab of the "SQL Server Inventory - Windows" workbook.
    ...
    .EXAMPLE
    Get-ComputerRegistry -Computer localhost
    ...
    process {
        try {
            ...
            foreach ($c in $Computer) {
                ...
                $CIMRegistry = Get-CimInstance -CimSession $CIMSession -Namespace $NameSpace -ClassName 'Win32_Registry'

                foreach ($Item in $CIMRegistry) {
                    ...
                    $Props = [PSCustomObject] @{
                        ...
                        'Current Size'    = $Item.'CurrentSize'
                        'Maximum Size'    = $Item.'MaximumSize'
                    }
                    $Props
                }
            }
