...
Describe "Tests for Subject Area '$SubjectArea'" -Tag $SubjectArea, SQLServer {
    ...
    Context 'Get-SqlServerManagementResourceGovernor' {
        It 'Returns some/any output for Get-SqlServerManagementResourceGovernor' {
            Set-ItResult -Skipped -Because 'cmdlet has not been written yet.'
        }
    }

    Context 'Get-SqlServerManagementSQLTrace' {
        It 'Returns some/any output for Get-SqlServerManagementSQLTrace' {
            Set-ItResult -Skipped -Because 'cmdlet has not been written yet.'
        }
    }

    Context 'Get-SqlServerManagementSQLTraceEvent' {
        It 'Returns some/any output for Get-SqlServerManagementSQLTraceEvent' {
            Set-ItResult -Skipped -Because 'cmdlet has not been written yet.'
        }
    }

    Context 'Get-SqlServerManagementSQLTraceFilter' {
        It 'Returns some/any output for Get-SqlServerManagementSQLTraceFilter' {
            Set-ItResult -Skipped -Because 'cmdlet has not been written yet.'
        }
    }

    Context 'Get-SqlServerManagementTraceFlag' {
        It 'Returns some/any output for Get-SqlServerManagementTraceFlag' {
            Set-ItResult -Skipped -Because 'cmdlet has not been written yet.'
        }
    }

    Context 'Get-SqlServerManagementDBMailAccount' {
        It 'Returns some/any output for Get-SqlServerManagementDBMailAccount' {
            Set-ItResult -Skipped -Because 'cmdlet has not been written yet.'
        }
    }

    Context 'Get-SqlServerManagementDBMailProfile' {
        It 'Returns some/any output for Get-SqlServerManagementDBMailProfile' {
            Set-ItResult -Skipped -Because 'cmdlet has not been written yet.'
        }
    }

    Context 'Get-SqlServerManagementDBMailSecurity' {
        It 'Returns some/any output for Get-SqlServerManagementDBMailSecurity' {
            Set-ItResult -Skipped -Because 'cmdlet has not been written yet.'
        }
    }

    Context 'Get-SqlServerManagementDBMailConfig' {
        It 'Returns some/any output for Get-SqlServerManagementDBMailConfig' {
            Set-ItResult -Skipped -Because 'cmdlet has not been written yet.'
        }
    }
