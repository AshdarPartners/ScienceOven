...
Describe "Tests for Subject Area '$SubjectArea'" -Tag $SubjectArea, SQLServer {
    ...
    Context 'Get-SqlServerConfigurationOverview' {
        It 'Returns some/any output for Get-SqlServerConfigurationOverview' {
            Set-ItResult -Skipped -Because 'cmdlet has not been written yet.'
        }
    }

    Context 'Get-SqlServerConfigurationGeneral' {
        It 'Returns some/any output for Get-SqlServerConfigurationGeneral' {
            Set-ItResult -Skipped -Because 'cmdlet has not been written yet.'
        }
    }

    Context 'Get-SqlServerConfigurationMemory' {
        It 'Returns some/any output for Get-SqlServerConfigurationMemory' {
            Set-ItResult -Skipped -Because 'cmdlet has not been written yet.'
        }
    }

    Context 'Get-SqlServerConfigurationProcessor' {
        It 'Returns some/any output for Get-SqlServerConfigurationProcessor' {
            Set-ItResult -Skipped -Because 'cmdlet has not been written yet.'
        }
    }

    Context 'Get-SqlServerConfigurationSecurity' {
        It 'Returns some/any output for Get-SqlServerConfigurationSecurity' {
            Set-ItResult -Skipped -Because 'cmdlet has not been written yet.'
        }
    }

    Context 'Get-SqlServerConfigurationConnection' {
        It 'Returns some/any output for Get-SqlServerConfigurationConnection' {
            Set-ItResult -Skipped -Because 'cmdlet has not been written yet.'
        }
    }

    Context 'Get-SqlServerConfigurationDatabaseSetting' {
        It 'Returns some/any output for Get-SqlServerConfigurationDatabaseSetting' {
            Set-ItResult -Skipped -Because 'cmdlet has not been written yet.'
        }
    }

    Context 'Get-SqlServerConfigurationAdvanced' {
        It 'Returns some/any output for Get-SqlServerConfigurationAdvanced' {
            Set-ItResult -Skipped -Because 'cmdlet has not been written yet.'
        }
    }

    Context 'Get-SqlServerConfigurationClustering' {
        It 'Returns some/any output for Get-SqlServerConfigurationClustering' {
            Set-ItResult -Skipped -Because 'cmdlet has not been written yet.'
        }
    }

    Context 'Get-SqlServerConfigurationAlwaysOn' {
        It 'Returns some/any output for Get-SqlServerConfigurationAlwaysOn' {
            Set-ItResult -Skipped -Because 'cmdlet has not been written yet.'
        }
    }

    Context 'Get-SqlServerConfigurationPermission' {
        It 'Returns some/any output for Get-SqlServerConfigurationPermission' {
            Set-ItResult -Skipped -Because 'cmdlet has not been written yet.'
        }
    }
